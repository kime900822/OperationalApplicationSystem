...
public class PaymentDAOImpl extends HibernateDaoSupport implements PaymentDAO {
	...
	public List<PaymentPO> dataTopaymentPo(List list){
	    ...
	    for(Iterator iterator = list.iterator();iterator.hasNext();){  
	        ...
	        paymentPO.setState(objects[6]==null?"":objects[6].toString());
	        paymentPO.setApplicant(objects[7]==null?"":objects[7].toString());
	        paymentPO.setDid(objects[8]==null?"":objects[8].toString());
	        paymentPO.setAmountInFigures(objects[9]==null?"":objects[9].toString());
	        paymentPO.setUsageDescription(objects[10]==null?"":objects[10].toString());
	        paymentPO.setSupplierCode(objects[11]==null?"":objects[11].toString());
	        paymentPO.setBeneficiaryE(objects[12]==null?"":objects[12].toString());
	        paymentPO.setPaymentDays(objects[13]==null?"":objects[13].toString());
	        paymentPO.setReceivingOrApprovalDate(objects[14]==null?"":objects[14].toString());
	        paymentPO.setPONo(objects[15]==null?"":objects[15].toString());
	        paymentPO.setCurrency(objects[16]==null?"":objects[16].toString());
	        paymentPO.setAmount(objects[17]==null?"":objects[17].toString());
