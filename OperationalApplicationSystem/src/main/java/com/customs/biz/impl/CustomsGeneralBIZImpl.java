	...
	public String getSQL(String month,String where) throws Exception {
		...
		if (flag) {
			earlySQL= 	" UNION all                                                                                                                "
					...
					+" t2.ID,"
					+" t2.Quantity,        "
					+" t4.quantityIssued as WriteOffVolume,  "
			...
			earlySQL= 	" UNION all                                                                                                                "
					...
					+" t2.ID ,   "
					+" t2.Quantity,                                                                                "
					+" IFNULL(sum(t4.quantityIssued),0) as WriteOffVolume,                                                                               "
					+ " null as pickingVolume,"
					+ " null as warehouseVolume,"
		...
		String sql=" select total.total.`Month`,"
				...
				+ " and total.prodectNo not in ('99991','99992','99993','99994','99995')"
				...
				+ " and total.JdeMaterialNo not like 'FREE9%'"
				+ " and total.prodectNo not in ('99991','99992','99993','99994','99995')"
				+ " then  FORMAT(total.WriteOffVolume*1.03/1000.0,4) else FORMAT(total.WriteOffVolume,2) end AS WriteOffVolume,"
				+ "CASE when total.Unit='米' "
				+ " and total.JdeMaterialNo not like 'FREE0%'"
				+ " and total.JdeMaterialNo not like 'FREE1%'"
				+ " and total.JdeMaterialNo not like 'FREE2%'"
				...
				+ " and total.JdeMaterialNo not like 'FREE9%'"
				+ " and total.prodectNo not in ('99991','99992','99993','99994','99995')"
				+ " then FORMAT(total.EarlyNumber + IFNULL(sum(total.Quantity),0)-total.WriteOffVolume*1.03/1000.0,4) " 
				...
				+ " and total.JdeMaterialNo not like 'FREE9%'"
				+ " and total.prodectNo not in ('99991','99992','99993','99994','99995')"
				+ " then round(MAX(total.price)*(total.EarlyNumber + IFNULL(sum(total.Quantity),0)-total.WriteOffVolume*1.03/1000.0),2) "
				+ " else round(MAX(total.price)*(total.EarlyNumber + IFNULL(sum(total.Quantity),0)-total.WriteOffVolume),2) end AS amount"
				+ " from (         "
				+" select                                                                                                                  "
				...
				+" t1.Id,"
				+" t1.Quantity ,"
				+" IFNULL(sum(t2.quantityIssued),0) as WriteOffVolume,                                                                               "
				+ " null as pickingVolume,"
				+ " null as warehouseVolume,"
