	...
	public String getSQL(String month,String where) throws Exception {
		...
		if (flag) {
			earlySQL= 	" UNION all                                                                                                                "
					...
					+ " then FORMAT(ROUND(sum(t4.quantityIssued)*(1+(case when t1.Unit='米' "
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE0%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE1%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE2%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE3%'"
					...
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE8%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE9%'"
					+ " then 0.03 else 0 end))/(case when t1.Unit='米' "
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE0%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE1%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE2%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE3%'"
					...
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE8%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE9%'"
					+ " then 1000.0 else 1.0 end),4),4) "
					+" else FORMAT(ROUND(sum(t4.quantityIssued)*(1+(case when t1.Unit='米' "
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE0%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE1%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE2%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE3%'"
					...
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE8%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE9%'"
					+ " then 1000.0 else 1.0 end),2),2) end as WriteOffVolume,  "
			...
			earlySQL= 	" UNION all                                                                                                                "
					...
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE8%'"
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE9%'"
					+ " then FORMAT(t1.EarlyNumber,4) else FORMAT(t1.EarlyNumber,2) END AS EarlyNumber,          "
					+" t2.ID ,   "
					+" t2.Quantity,                                                                                "
					+" CASE when t1.Unit='米' "
					+ " and IFNULL(t6.NewMaterialNo,t1.JdeMaterialNo) not like 'FREE0%'"
		...
		String sql=" select total.total.`Month`,"
				...
				+ "CASE " 
				+ "when total.Unit='米' "
				+ " and total.JdeMaterialNo not like 'FREE0%'"
				+ " and total.JdeMaterialNo not like 'FREE1%'"
				+ " and total.JdeMaterialNo not like 'FREE2%'"
				+ " and total.JdeMaterialNo not like 'FREE3%'"
				+ " and total.JdeMaterialNo not like 'FREE4%'"
				+ " and total.JdeMaterialNo not like 'FREE5%'"
				+ " and total.JdeMaterialNo not like 'FREE6%'"
				+ " and total.JdeMaterialNo not like 'FREE7%'"
				+ " and total.JdeMaterialNo not like 'FREE8%'"
				+ " and total.JdeMaterialNo not like 'FREE9%'"
				+ " then FORMAT(IFNULL(sum(total.Quantity)," 
				+ " 0)," 
				+ " 4) " 
				...
				+ " and total.JdeMaterialNo not like 'FREE8%'"
				+ " and total.JdeMaterialNo not like 'FREE9%'"
				+ " then FORMAT(total.EarlyNumber + IFNULL(sum(total.Quantity)," 
				+ " 0)-IFNULL(total.WriteOffVolume,0)," 
				+ " 4) " 
				...
				+ "total.currency,"
				+ "round(total.price*(total.EarlyNumber + IFNULL(sum(total.Quantity),0)-IFNULL(total.WriteOffVolume,0)),2) AS amount"
				+ " from (         "
				+" select                                                                                                                  "
				...
				+" CASE When t3.declareUnitCode='030' "
				...
				+ " then FORMAT(0,4) else FORMAT(0,2) end as EarlyNumber,                                                                                                       "
				+" t1.Id,"
				+" t1.Quantity ,"
				+" CASE When t3.declareUnitCode='030' "
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE0%'"
				...
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE8%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE9%'"
				+ " then FORMAT(ROUND(sum(t2.quantityIssued)*(1+(case when t3.declareUnitCode='030' "
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE0%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE1%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE2%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE3%'"
				...
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE8%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE9%'"
				+ " then 0.03 else 0 end))/(case when t3.declareUnitCode='030' "
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE0%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE1%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE2%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE3%'"
				...
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE9%'"
				+ " then 1000.0 else 1.0 end),4),4) "
				+" else FORMAT(ROUND(sum(t2.quantityIssued)*(1+(case when t3.declareUnitCode='030' "
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE0%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE1%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE2%'"
				+ " and IFNULL(t4.NewMaterialNo,t1.CimtasCode) not like 'FREE3%'"
