...
public class PDFUtil {
	...
	public static ByteArrayOutputStream  printPDF(Map<String, String> map,String url) throws Exception {
		...
		BaseFont bf = BaseFont.createFont(Message.PRINT_FONT, BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
...
//		BaseFont bfChinese = BaseFont.createFont("STSongStd-Light", "UniGB-UCS2-H",
//                BaseFont.NOT_EMBEDDED);
		BaseFont bfChinese = BaseFont.createFont(Message.PRINT_FONT, BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
