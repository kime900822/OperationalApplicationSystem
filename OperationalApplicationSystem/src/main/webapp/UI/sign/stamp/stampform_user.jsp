    ...
    <fieldset>
        ...
        <table	>
        	<tr>
        		...
        		<td>
            	<input type="text" name="Cimtas ID" value="" id="q_stamp_applicationCode" size="15">
        		</td>
        		<td width="80px">
        		<span>Urgent：</span>
        		</td>
        	...
        	<tr>
        		...
        		<td>
            	<select name="documentType" data-toggle="selectpicker" id="q_stamp_documentType"  data-width="200px">
	              <option value=""></option>
    ...
    <table class="table table-bordered" id="datagrid-stamp-user-filter" data-toggle="datagrid" data-options="{
        ...
        <thead>
            <tr>
				...
				<th data-options="{name:'urgent',width:150,align:'center' ,finalWidth:'true',type:'select', items:datagrid_urgent}">Cimtas ID</th>
				<th data-options="{name:'formFiller',width:200,align:'center',finalWidth:'true',type:'select', items:datagrid_stampSubject}">User Name</th>
				<th data-options="{name:'documentType',width:200,align:'right',finalWidth:'true',type:'select',itemattr:{value:'id',label:'value'},items:$.getJSON('getCheckType4Select.action')}">Document Type</th>
				<th data-options="{name:'stampType',width:120,align:'right',finalWidth:'true'}">Stamp Type</th>
				<th data-options="{name:'urgent',width:120,align:'right',finalWidth:'true'}">Urgent</th>
