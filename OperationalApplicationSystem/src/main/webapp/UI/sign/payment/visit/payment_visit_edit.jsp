    ...
    <div class="bs-example" >
        <form action="modPaymentVisitEmployee.action?callback=?" class="datagrid-edit-form" data-toggle="validate" data-data-type="jsonp">
            <div class="bjui-row col-2">
                ...
                <label class="row-label">Visit Employee No.*<br>出差人员</label>
                ...
                <div class="row-input required">
                    <select name="hotelBookingByHR" data-toggle="selectpicker" value="${param.hotelBookingByHR}"  data-rule="required" data-width="100%"  >
                ...
                <div class="row-input">
                    <input type="text" name="hotelName"  id="j_payment_visit_employee_hotelName" value="${param.hotelName}">
                </div>
                <label class="row-label">B.是否HR派车<br>Car Arrange by HR</label>
                <div class="row-input required">
                    <select name="carArrangeByHR" data-toggle="selectpicker" value="${param.carArrangeByHR}"  data-rule="required" data-width="100%"  >
                         <option value="" selected></option>
                         <option value="是" >是</option>
                         <option value="否" >否</option>
                    </select>
                ...
                <div class="row-input">
                    <input type="text" name="carArrangePeriod"  id="j_payment_visit_employee_carArrangePeriod"  value="${param.carArrangePeriod}"  data-toggle="datepicker" placeholder="点击选择日期" data-nobtn="true" data-pattern="yyyy-MM-dd HH:mm:ss">
                </div>
                <label class="row-label">C.是否HR定机票<br>Air Ticket Booking by HR</label>
                <div class="row-input required">
                    <select name="airTickerBookingByHR" data-toggle="selectpicker" value="${param.airTickerBookingByHR}"  data-rule="required" data-width="100%"  >
                         <option value="" selected></option>
                         <option value="是" >是</option>
                         <option value="否" >否</option>
                    </select>
                ...
                <div class="row-input">
                    <input type="text" name="flightNO"  id="j_payment_visit_employee_flightNO" value="${param.flightNO}">
                </div>
