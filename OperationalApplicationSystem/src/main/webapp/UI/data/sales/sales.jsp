...
<div class="bjui-pageContent" id="div-user">
    <table class="table table-bordered" id="datagrid-user-filter" data-toggle="datagrid" data-options="{
        height: '100%',
        gridTitle : 'Sales Import',
        showToolbar: true,
        toolbarItem: 'refresh,|,import,export',
        dataUrl: 'getSales.action',
        fieldSortable: false,
        filterThead: false,
        linenumberAll: true,
        paging: false,
        contextMenuB: true,
        hScrollbar: true,
        importOption: {type:'dialog', options:{url:'data/sales/sales-import.html', width:500, height:300, title:'Import Instruction'}},
        exportOption: {type:'file', options:{url:'exportSalesExcel.action', loadingmask:false}}
    }">
        <thead>
            <tr>
